...
<form name="myForm" action="logp.php" onsubmit="return validateForm()" method="post">
<div class="login-box">
  <h1>Login</h1>
  <div class="textbox">
...
<br>  
<input type="submit" id="inp1" on click ="chng()" class="btn" value="Submit"><br>
<input type="button"  onclick="location.href='signup.php';"class="btn" value="Register"><br>
</div>
</form>