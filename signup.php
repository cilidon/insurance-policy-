<head><link rel="stylesheet" href="regsty.css">
...
<script>
 ...
 <form  name="myForm" onsubmit="return validateForm()" action="regp.php" method="post" autocomplete="off">
<div class="reg-box">
  <h1>Register</h1>
  <div class="textbox1">
    <i class="fas fa-user"></i>
    <input type="text" name="un" placeholder="UserName"  ></div>
    <?php 
      if(isset($_GET['error']))
 ...
 <label id="l3" style="color:red;visibility:hidden;">z</label>
  <div class="textbox1">
    ...
    <input type="text" name="em" placeholder="Email Id">
  </div>
  <label id="l4" style="color:red;visibility:hidden;">z</label>
  <div class="textbox1">
    <i class="fas fa-mobile-alt"></i>
    <input type="text" name="mn" placeholder="Mobile Number">
  </div>
    <label id="l5" style="color:red;visibility:hidden;">z</label>
    <div class="textbox1">
    <i class="far fa-calendar-alt"></i>
    <input type="date" name="dt" placeholder="Date of Birth">
  </div>
